...
function displayRepositories(){
  ...
  const repoList = `<ul>${repos.map(r => `<li>/${r.name}/ /${r.owner.login}/ /${r.html_url}/ <br> <a href="#" data-repository="${r.name}" data-username="${r.owner.login}" onclick="getCommits(this)">Get Commits</a> <br>
